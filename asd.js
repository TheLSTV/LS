    ...
    var LS = {
        ...
        TinyFactory(r){
            return{
                ...
                get:(selector = '*') => O(r, selector),
                getChildern(){return [...r.children]},
                ...
                hide(){ r.style.display = "none"; return r },
                show(c){ r.style.display = c || "inherit"; return r },
                applyStyle(rules){
                ...
                getStyle(){return getComputedStyle(r)},
                set:(...a)=>{
                    r.innerHTML = '';
                    return r.add(...a)
                },
