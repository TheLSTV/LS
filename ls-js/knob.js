{
    ...
    return _this=>class LS_Knob{
        constructor (id, element, style = "default", options = {}) {
            ...
            handle.on("move", (x,y,e)=>_this.draw(e))
        ...
        draw(e){
            let step = e? e.movementY * _this.options.step : 0;
            if(_this.value - step < _this.options.min || _this.value - step > _this.options.max){
                return
            }
            _this.value -= step;
        ...
        drawInit(){
            ...
            if(_this.style.arc){
                ...
                _this.arc.show()
            }else if(_this.arc){_this.arc.hide()}
