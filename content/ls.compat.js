...
String.prototype.replaceAll || (String.prototype.replaceAll = function (a, b) {
  return "[object regexp]" === Object.prototype.toString.call(a).toLowerCase() ? this.replace(a, b) : this.replace(new RegExp(a, "g"), b);
});
if (!((_window = window) !== null && _window !== void 0 && _window.Globalise)) {
  window.Globalise = (...b) => b.map(a => typeof a == 'string' ? (() => {
    var _window2;
    return window[a] = ((_window2 = window) === null || _window2 === void 0 ? void 0 : _window2[a]) || null;
  })() : Array.isArray(a) ? a.map(v => {
    var _window3;
    return window[v] = ((_window3 = window) === null || _window3 === void 0 ? void 0 : _window3[v]) || null;
  }) : Object.keys(a).map(v => window[v] = a[v]));
}
if (!LS) var LS = {
  /*--part--(tiny){*/
  Util: {
    resolve(...a) {
      return a.flat(Infinity).map(i => {
        if (i !== null && i !== void 0 && i.tagName) return i;
  ...
  Tiny: {
    Q: (e, q) => {
      var _ref;
      return Object.assign((_ref = e !== null && e !== void 0 && e.tagName && !q ? [e] : [...(e !== null && e !== void 0 && e.tagName ? e : D()).querySelectorAll(e !== null && e !== void 0 && e.tagName ? !q ? '*' : q : typeof e == 'string' ? e : '*')]) === null || _ref === void 0 ? void 0 : _ref.map(r => {
        if (!r._affected) Object.assign(r, {
          _affected: !0,
          isElement: !0,
          attr(specific = !1, value = !1) {
            if (value) {
              r.setAttribute(specific, value);
              return value;
            }
            ;
          ...
          delAttr(...a) {
            a = a.flat(2);
            a.forEach(a => r.removeAttribute(a));
          },
          ...
          path: () => {
            let p = [r],
              i = 0;
            while (((_p = p[p.length - 1]) === null || _p === void 0 ? void 0 : _p.tagName) != 'HTML') {
              var _p;
              p.push(r.parent(i));
              i++;
            }
    ...
    U(url = location.href) {
      return Object.assign(new URL(url), {
        ...
        params(specific = !1) {
          ...
          let o = {};
          url.replaceAll(/(.*?)\?/gi, '').split('&').forEach(e => {
            var _e;
            e = e.split('=');
            o[e[0]] = decodeURIComponent((_e = e) === null || _e === void 0 ? void 0 : _e[1]).replace(/#(.*)/g, "");
          });
          return specific ? o[specific] : o;
        }
      });
    },
    M: {
...
M.on("mousemove", e => {
  M.x = e.clientX;
  M.y = e.clientY;
}).on("keypress", e => M.lastKey = e.key).on("mousedown", e => M.mouseDown = !0).on("mouseup", e => M.mouseDown = !1);
/*--}*/

(c => {
  Object.keys(c).forEach(D => {
    if (LS[D]) {
      console.warn("[LS] Duplicate component name \"" + D + "\"");
      return;
    }
    ;
    function instance(...a) {
    ...
    LS[D].new = function (id, ...a) {
      ...
      i.once = function (type, evt, extra) {
        this.on(type, evt, {
          once: true,
          ...extra
        });
      ...
      i.invoke = function (evt, ...a) {
        if (!this.events.includes(evt)) this.events.push(evt);
        this.listeners.filter(l => l.for == evt).forEach(e => {
          e.f(...a);
          if (e.once) this.listeners = this.listeners.filter(e => e.id !== e.id);
        });
      };
      if (i._init) i._init();
    ...
    return _this => class Modal {
      constructor(id, content = N(), opt = {}) {
        ...
        this.element = N("div", {
          ...
          style: opt.style,
          onclick: e => {
            if (opt.cancelable && O(e.target).attr("ls-modal")) this.hide();
          },
          inner: [content]
        });
  ...
  Dialog(global) {
    ...
    return _this => (opt = {}) => {
      var _opt, _opt2, _opt2$content, _opt2$content$trim, _opt$buttons, _opt$buttons$map;
      opt = Object.assign({
        title: "Alert",
        content: "",
        cancelable: true,
      ...
      let m = new LS.Modal.new(null, !opt.use ? N('div', {
        inner: [N('span', {
          inner: [N("b", (_opt = opt) !== null && _opt !== void 0 && _opt.title ? opt.title + "<br>" : ""), N("span", (_opt2 = opt) === null || _opt2 === void 0 ? void 0 : (_opt2$content = _opt2.content) === null || _opt2$content === void 0 ? void 0 : (_opt2$content$trim = _opt2$content.trim) === null || _opt2$content$trim === void 0 ? void 0 : _opt2$content$trim.call(_opt2$content))]
        }), N('div', {
          inner: opt.loading ? [N("div", {
            attr: ["ls-load"]
          })] : (_opt$buttons = opt.buttons) === null || _opt$buttons === void 0 ? void 0 : (_opt$buttons$map = _opt$buttons.map) === null || _opt$buttons$map === void 0 ? void 0 : _opt$buttons$map.call(_opt$buttons, b => N('button', Object.assign({
            attr: ["ls", "fluent", b.color ? "ls-" + b.color : 'ls-blue'],
            inner: b.text
          }, (b === null || b === void 0 ? void 0 : b.element) || {}))),
          attr: ["dialog_bottom"]
        })],
  ...
  Tabs() {
    return _this => class Tabs {
      constructor(id, e = O("tabs"), opt = {}) {
        ...
        if (this.opt.list) {
          _this._list = _this.opt.listElement || N("div", {
            className: "tablist " + _this.opt.listClass
          });
          if (!_this.opt.listElement) O(e).prepend(_this._list);
        }
      ...
      register(t) {
        ...
        let nt = N("div", {
          innerHTML: t.attr("tab-title"),
          attr: {
            for: t.attr("tab-id")
          },
          className: "_tab " + (_this.opt.noStyle ? "" : "_tab_style ") + _this.opt.listItemClass,
          onclick: function () {
            if (_this.opt.listClickable) _this.setActive(this);
          }
        });
        _this.list.push(nt);
  ...
  Steps() {
    return _this => class Steps {
      constructor(id, e = O("steps"), o = {}) {
        ...
        e = O(e);
        if (!o.prevBtn) {
          o.prevBtn = N("button", "Previous");
          e.add(o.prevBtn);
        }
        ;
        if (!o.nextBtn) {
          o.nextBtn = N("button", "Next");
          e.add(o.nextBtn);
        }
        ;
        this.opt = Object.assign({
        ...
        let nb = O(this.opt.nextBtn),
          pb = O(this.opt.prevBtn),
          nt = nb.innerHTML;
        nb.onclick = () => {
          if (_this.step == this.stack.length - 1) {
            _this.updateOptions();
            _this.invoke("done", _this.options);
          }
          _this.next();
        };
        ...
        _this.tabs.tabs.forEach(t => {
          t.getAll("[option],[option-radio]").forEach((o, i) => {
            ...
            function re(click = false) {
              ...
              if (isNull) {
                _this.options[o.attr("group")] = null;
              }
              ;
      ...
      reset() {
        ...
        _this.element.getAll("[default]").forEach(d => d[{
          IMG: "src"
        }[d.tagName] || "value"] = O(d).attr("default"));
  ...
  Select() {
    return _this => class Select {
      constructor(id, e) {
        ...
        this.menu = N({
          ...
          inner: [N("input", {
            placeholder: "Search",
            oninput: function () {
              _this.menu.getAll(".ls-select-option").forEach(e => e.style.display = (e.innerText + e.attr(this.value)).toLowerCase().replace(/[\s\n:|_]/g, '').includes(this.value.toLowerCase().replace(/[\s\n:|_]/g, '')) ? "block" : "none");
            }
          }), "<hr>", N({
        ...
        this.shown = !1;
        this.element.on("click", () => this.toggle()).on("keydown", e => {
      ...
      update() {
        _this.menu.get(".ls-select-options").set(_this.selectElement.getAll("optgroup,option,ls-option").map(c => N(c.tagName == "OPTGROUP" ? {
          inner: c.attr("label"),
          ...
          class: "ls-select-option" + (c.parentElement.tagName == "OPTGROUP" ? " ls-select-labeled" : ""),
          style: c.parentElement.hasAttribute("disabled") || c.attr("disabled") ? "opacity:.4;pointer-events:none" : "",
          onclick: function () {
            _this.set(this.attr("value") || this.innerText, this.innerText);
          }
        })));
      }
      toggle() {
      ...
      position() {
        ...
        _this.menu.style = `left:${r.left}px;width:${r.width}px;top:${r.top + r.height}px;max-height:${Math.min(innerHeight - (r.top + r.height + 20), 400)}px`;
        S(_this.menu, {
          display: "block"
        });
      }
  ...
  Chips() {
    return _this => class Chips {
      ...
      updateChips() {
        ...
        _this.chips.forEach(c => c.onclick = function () {
          _this.chips.filter(a => a != this).forEach(e => e.removeAttribute("selected"));
  ...
  Notif() {
    return _this => class Notif {
      constructor(id, opt = {}) {
        this.el = N({
          class: "ls-notif-area",
          style: `width:${opt.width || 300}px`,
          inner: [N({
            class: "ls-notif-scroll",
            inner: N({
              class: "ls-notif-container"
            })
          }), N({
            class: "ls-notif-hide",
            inner: "<i class=bi-caret-down-fill></i>",
            onclick: () => {
      ...
      push(c) {
        return new Promise(r => {
          ...
          let e = N({
            class: "ls-notif",
            inner: [c.title ? N("b", c.title + "<br>") : "", c.content],
            style: "color:var(--color-bg)",
            attr: [c.color ? "ls-" + c.color : ""]
          });
  ...
  Console() {
    return _this => class Tree {
      constructor(id, e = O("console"), options = {}) {
        ...
        _this = this;
        if (_this.opt.overwrite) {
          this._console = Object.assign(console, this.__proto__);
          console = this;
        }
        ;
      }
      addLine(opt, ...t) {
        if (_this.lines >= _this.opt.max_lines) {
          _this.element.child().remove();
          _this.lines--;
        }
        ;
        let ts = "",
          ...
          t[i] = line.split("%{").map(c => {
            ...
            if (i != -1) {
              ...
              return "<span style=\"" + s.split(";").map(s => {
                if (!s.includes(":")) {
                  return s.split(",").map((v, i) => `${["color", "background", "outline", "font-style", "font-weight", "text-decoration", "cursor"][i] || "color"}:${v || "unset"}`).join(";");
                } else {
                  return s;
                }
        ...
        let result = N("span", {
          innerHTML: `<span style=color:${opt.color || _this.opt.color || 'inherit'}>${ts}${t.join("\n" + " ".repeat(indent))}\n` + "</span>".repeat(styles + 1)
        });
      ...
      clear() {
        _this.element.set();
        _this.lines = 0;
        if (_this.opt.proxy) _this._console.clear();
        _this.invoke("clear");
      }
      get() {}
      error(...t) {
  ...
  Editor(global) {
    ...
    return _this => class Editor {
      constructor(id, e, opt) {
        ...
        this.element.set([N("div", {
          className: "ls-editor-inner",
          style: S({
            position: "absolute",
            display: "block",
            width: "100%",
          ...
          inner: [N("div", {
            ...
            className: "ls-editor-edit ls-editor-text",
            inner: ["hi"],
            oninput: function () {
      ...
      style(theme) {
        ...
        Object.keys(r).forEach(k => {
          console.warn(_this.element.querySelectorAll("*"));
          (k == "body" ? [_this.element] : _this.element.querySelectorAll(k)).forEach(e => {
            console.log(1, e, r[k]);
            S(e, r[k]);
          });
        });
...
Globalise({
  alert: (m, opt = {}) => new Promise(r => modal(Object.assign({
    content: m,
    buttons: [{
      text: "OK"
    }],
  ...
  confirm: (m, opt = {}) => new Promise(r => modal(Object.assign({
    content: m,
    buttons: [{
      text: "OK"
    }, {
  ...
  prompt: (m, opt = {}) => new Promise(r => modal(Object.assign({
    content: m + "<br><input type=text ls fluent>",
    buttons: [{
      text: "OK"
    }, {
      text: "Cancel"
